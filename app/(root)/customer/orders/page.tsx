...
function OrdersPage() {
  ...
  return (
    <div id="order-history-container"  className="mt-40   justify-self-center   text-black">
      <h1 className=" text-black font-sans font-semibold pb-3 sm:font-bold text-xl sm:text-2xl text-left text-pretty tracking-tight">Order history</h1>
                ...
                <div className=" w-full">
                  ...
                  <ul key={order.items._id} >
                    ...
                    <div className="md:flex md:justify-between items-center ">
                      ...
                      <div>
                        <button className="md:py-1 py-1 md:px-2 px-2  border border-lg border-black  text-black   hover:bg-black hover:text-white">See Details</button>
                      </div>
                    </div>
